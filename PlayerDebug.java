...
public class Player {
	...
	public void takeBet(int bet) {
		...
		System.out.println("balance before deducting bet = "+ balance);
		balance = balance - bet;
	}
	
	public void receiveWinnings(int winnings) {
		if (winnings < 0) throw new IllegalArgumentException("Winnings cannot be negative.");
		//checking balance variable before adding the winnings 
		System.out.println("balance before adding = "+balance);
		balance = balance + winnings;		
		System.out.print("balance after adding = "+balance);
		//checking balance variable after adding the winnings
	}
